    ...
    return (
        <div className='lmj-cart'>
            ...
            <div className="clone">
                ...
                <button className="glow-on-hover" onClick={() => updateCart(cart + 1)}>
                    AJOUTER
                </button>
                {cart > 0 ? <button className="glow-on-hover" onClick={() => updateCart(cart - 1)}>
                    SUPPRIMER
            ...
            <div className="place">
                ...
                <button className="glow-on-hover" onClick={() => updateCartPlace(cartPlace + 1)}>
                    AJOUTER
                </button>
                {cartPlace > 0 ? <button className="glow-on-hover" onClick={() => updateCartPlace(cartPlace - 1)}>
                    SUPPRIMER
